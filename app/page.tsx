...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#f2efe9] text-[#1c3a4b] font-sans scroll-smooth relative overflow-x-hidden">
      ...
      {/* --- BANNER SECTION (MOBILE COM GUARDA-CHUVA GIGANTE OCUPANDO A ÁREA MARCADA) --- */}
      <section className="relative w-full bg-[#f2efe9]">
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-end px-4 text-center pb-20 md:pb-40 overflow-hidden">
            ...
            {/* --- NOVO: ÍCONE GUARDA-CHUVA SUPER GIGANTE (APENAS MOBILE) --- */}
            {/* w-screen = Largura total da tela
                h-[400px] = Altura fixa grande
                -mt-52 = Puxa para cima para cobrir a área desenhada
                -ml-4 = Ajuste fino para centralizar considerando o padding pai
            */}
            <div className="relative w-screen h-[400px] md:hidden mb-0 -mt-52 -ml-4 animate-in fade-in slide-in-from-bottom-4 duration-700 pointer-events-none">
                <Image
